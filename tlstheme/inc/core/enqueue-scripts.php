...
function tls_enqueue_frontend_scripts() {
    ...
    wp_enqueue_style('tls-pro-fonts', 'https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&family=Inter:wght@300;400;500;600;700&display=swap', [], null);
