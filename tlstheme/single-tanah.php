            ...
            <div class="single-tanah-main">
                ...
                <div class="single-tanah-content">
                    ...
                    <div class="dokumen-section">
                        ...
                        <center>
                            <a href="https://wa.me/<?php echo esc_attr($wa); ?>?text=<?php echo urlencode('Saya ingin melihat dokumen untuk Property ID: ' . $property_id); ?>" class="btn-dokumen" target="_blank">
